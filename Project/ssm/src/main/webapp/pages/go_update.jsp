    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/go/findAll">产品管理</a></li>
                <li class="active">产品表单</li>
            </ol>
        </section>
        <form action="${pageContext.request.contextPath}/go/update?id=${go.go_id}"
              method="post">
            <!-- 正文区域 -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="go_id"
                                   placeholder="产品编号" value="${go.go_id}">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="捐赠款项"
                                   name="go_value" value="${go.go_value}">
                        </div>

                        <div class="col-md-2 title">接收方</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="接收方"
                                   name="receiver" value="${go.receiver}">
                        </div>

                        <div class="col-md-2 title">用途</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="用途"
                                   name="purpose" value="${go.purpose}">
                        </div>
