                            ...
                            <div class="col-lg-2">
                                <div class="inbox-email-menu-list compose-b-mg-30 shadow-reset">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li ><a href="${pageContext.request.contextPath}/pages/hu_fo.jsp"><span
                                                class="inbox-icon"><i
                                        ...
                                        <li class="active"><a href="${pageContext.request.contextPath}/pages/hu_go.jsp"><span
                                                class="inbox-icon"><i
...
<script>
        ...
        columns: [{
            ...
            formatter: function (value, row, index) {
                ...
                var watchStr = '<button type="button"\n' +
                    ...
                    '                                                                    onclick="location.href=\'${pageContext.request.contextPath}/go/find?id=' + aId + '\'">详情\n' +
                    '                                                            </button>'
                var delStr = '<button type="button"\n' +
                    '                                                                    class="btn bg-olive btn-xs"\n' +
                    '                                                                    onclick="location.href=\'${pageContext.request.contextPath}/go/delete?id=' + aId + '\'">删除\n' +
                    '                                                            </button>'
                var updateStr = '<button type="button"\n' +
                    '                                                                    class="btn bg-olive btn-xs"\n' +
                    '                                                                    onclick="location.href=\'${pageContext.request.contextPath}/go/find?id=' + aId + '\'">更新\n' +
                    '                                                            </button>'
    ...
    function searchID() {
        ...
        if (IDend == null || IDend == "")
            IDend = 110773;
        $('#mytab').bootstrapTable('filterBy', {go_id: [IDbegin, IDend]},
            {
                'filterAlgorithm': function (row, filters) {
                    return row.go_id >= filters.go_id[0] && row.go_id <= filters.go_id[1];
                }
            }
        );
    }
    ...
    function searchAll() {
        ...
        $('#mytab').bootstrapTable('filterBy', {go_id: [IDbegin, IDend], go_date: [DATEbegin, DATEend]},
            {
                'filterAlgorithm': function (row, filters) {
                    if (filters.go_date[0] == "")
                        if (row.go_id >= filters.go_id[0] && row.go_id <= filters.go_id[1])
                            return true;
                    if (filters.go_id[0] == "") {

                        if (row.go_date >= filters.go_date[0] && row.go_date <= filters.go_date[1])
                            return true;
                    }
                    if (row.go_date >= filters.go_date[0] && row.go_date <= filters.go_date[1] && row.go_id >= filters.go_id[0] && row.go_id <= filters.go_id[1])
                        return true;
                    return false;
                }
            }
    ...
    function searchDATE() {
        ...
        if (DATEend == null || DATEend == "")
            DATEend = '2020-06-31';
        $('#mytab').bootstrapTable('filterBy', {go_date: [DATEbegin, DATEend]},
            {
                'filterAlgorithm': function (row, filters) {
                    return row.go_date >= filters.go_date[0] && row.go_date <= filters.go_date[1];
                }
            }
        );
    }
