                                            ...
                                            <div class="content-wrapper">
                                                ...
                                                <section class="content-header">
                                                    ...
                                                    <ol class="breadcrumb">
                                                        ...
                                                        <li><a
                                                                href="${pageContext.request.contextPath}/fi/findAll">资金接受</a></li>
                                                        <li class="active">详情</li>
                                                    </ol>
                                                </section>
                                                <form action="${pageContext.request.contextPath}/fi/update?id=${fi.fi_id}"
                                                      method="post">
                                                    <!-- 正文区域 -->
                                                    <section class="content"  style = "margin-top: 50px"> <!--产品信息-->
                                                            ...
                                                            <div class="row data-type">
                                                                ...
                                                                <div class="col-md-4 data">
                                                                    <div class="input-group date">
                                                                        ...
                                                                        <input type="text" class="form-control pull-right"
                                                                               id="datepicker-a3" name="fi_date" value="${fi.fi_date}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4 data">
                                                                    <input type="text" class="form-control" placeholder="名义"
                                                                           name="in_name" value="${fi.in_name}">
                                                                </div>
                                                                <div class="col-md-2 title">捐赠模式</div>
                                                                <div class="col-md-4 data">
                                                                    <label for="state"></label><select class="form-control select2" style="width: 100%" name="m_id" id="state">
                                                                    <option value="1">微信捐款</option>
                                                                ...
                                                                <div class="col-md-4 data">
                                                                    <input type="text" class="form-control" placeholder="标记"
                                                                           name="sign" value="${fi.sign}">
                                                                </div>
                                                                <div class="col-md-2 title rowHeight2x">其他信息</div>
                                                                <div class="col-md-10 data rowHeight2x">
							<textarea class="form-control" rows="3" placeholder="其他信息"
                                      name="productDesc" cols="3"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--订单信息/--> <!--工具栏-->
                    ...
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &#169; 2020 HZR All rights reserved.<a
                                    href="http://www.cssmoban.com/" target="_blank" title="数据库">数据库项目</a> - Collect from
                                <a
