                            ...
                            <div class="col-lg-2">
                                <div class="inbox-email-menu-list compose-b-mg-30 shadow-reset">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active"><a href="${pageContext.request.contextPath}/fo/findAll?page=1&size=4"><span
                                                class="inbox-icon"><i
                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <div class="box-tools pull-right">
                                                                <div class="has-feedback">
                                                                    <form action="${pageContext.request.contextPath}/fo/selectlike" method="post">
                                                                        <div>
                                                                            日期：
                                                                        ...
                                                                        <div>
                                                                            捐赠者：
                                                                            <input type="text" class="form-control input-sm"
                                                                                   placeholder="搜索捐款方" name="thepayer">
                                                                        </div>
                                                                        <div>
                                                                            接受者：
                                                                            <input type="text" class="form-control input-sm"
                                                                                   placeholder="搜索接收方" name="thepayee">
                                                                        </div>
                                                                        <span class="glyphicon glyphicon-search form-control-feedback"></span>
                                                                    ...
                                                                    <c:forEach items="${list}" var="fo">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">
                                                                                <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/fo/find?id=${fo.fo_id}'">详情</button>
                                                                                <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/fo/delete?id=${fo.fo_id}'">删除</button>
                                                                                <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/fo/find?id=${fo.fo_id}'">编辑</button>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </c:forEach>
