                            ...
                            <div class="col-lg-2">
                                <div class="inbox-email-menu-list compose-b-mg-30 shadow-reset">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="active"><a href="${pageContext.request.contextPath}/go/findAll?page=1&size=4"><span
                                                class="inbox-icon"><i
                                                        ...
                                                        <div class="box-body">
                                                                ...
                                                                <div class="form-group form-inline">
                                                                    <div class="btn-group">
                                                                        <button type="button" class="btn btn-default" title="新建"
                                                                                onclick="location.href='${pageContext.request.contextPath}/pages/go_add.jsp'">
                                                            ...
                                                            <div class="box-tools pull-right">
                                                                <div class="has-feedback">
                                                                    <form action="${pageContext.request.contextPath}/go/selectlike?page=1&size=4" method="post">
                                                                ...
                                                                <table class="table table-hover" id="dataList">
                                                                    ...
                                                                    <c:forEach items="${list}" var="go">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>${go.unit}</td>
                                                                            <td>${go.go_value}</td>
                                                                            <td>${go.goodType.type}</td>
                                                                            <td>${go.receiver}</td>
                                                                            <td>${go.purpose}</td>
                                                                            <td>${go.province.city}</td>
                                                                            <td>${go.sign}</td>
                                                                            <td class="text-center">
                                                                                <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/go/find?id=${go.go_id}'">详情</button>
                                                                                <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/go/delete?id=${go.go_id}'">删除</button>
                                                                                <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/go/find?id=${go.go_id}'">编辑</button>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </c:forEach>
