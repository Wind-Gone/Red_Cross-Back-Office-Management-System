...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/go/save"
              method="post">
            <!-- 正文区域 -->
            <section class="content"> <!--产品信息-->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-2 title">物资种类</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="go_type"
                                   placeholder="物资名称" value="">
                        </div>
